...
<div class="container">
    <div class="panel panel-primary">
        <div class="panel-heading">Szczegółowe informacje o kliencie</div>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">Pojazdy przypisane do klienta:</div>
        <div class="panel-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${vehicles}" var="vehicle">
                        <tr>
                            ...
                            <td>
                                <a href="/null/vehicles/edit?vehicleId=${vehicle.id}"
            ...
            <button class="btn btn-info center-block" type="button" data-toggle="collapse" data-target="#newVehicle">
                Utwórz nowy pojazd
            </button>
    ...
    <div id="newVehicle" class="collapse col-sm-offset--1">
        <%@include file="../vehicles/form_add.jsp" %>
    </div>
